...
#define COPROC_3_RST 0x40000090
#define COPROC_4_RW 0x40000094

#define OLEDCHARMAP_RST 0x400000A0
#define OLEDCHARMAP_RW 0x400000A8

#define OLEDTERMINAL_RST 0x400000A4
#define OLEDTERMINAL_RW 0x400000AC

#define CTRL_SL_RST 0x400000C0
#define CTRL_SL_RW 0x400000C4

#define OLEDBITMAP_RST 0x400000B0
#define OLEDBITMAP_RW 0x400000B8

#define OLEDNIBBLEMAP_RST 0x400000B4
#define OLEDNIBBLEMAP_RW 0x400000BC

#define OLEDSIGPLOT_RST 0x400000D0
#define OLEDSIGPLOT_RW 0x400000D8
